...
const mvHairOil: ProductData = {
  ...
  subcategory: 'cosmetic',
  subscriptionMonth: 10,
  images: ['https://images.unsplash.com/photo-1527799820374-dcf8d9d4a388?w=400&h=400&fit=crop'],
  galleryImages: [],
  thumbnails: [],
  videoUrls: [],
  mainVideoUrl: '',
...
const mvBathSalt: ProductData = {
  ...
  subcategory: 'cosmetic',
  subscriptionMonth: 11,
  images: ['https://images.unsplash.com/photo-1600334089648-b0d9d3028eb2?w=400&h=400&fit=crop'],
  galleryImages: [],
  thumbnails: [],
  videoUrls: [],
  mainVideoUrl: '',
