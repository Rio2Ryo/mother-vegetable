    ...
    <main className="min-h-screen bg-black text-white">
      <section className="relative overflow-hidden px-6 py-24 md:py-28">
        ...
        <div className="relative mx-auto max-w-5xl">
          ...
          <p className="mt-6 text-2xl font-semibold text-white/90">Mother Vegetableの商品を世界へ</p>
          <p className="mt-6 max-w-3xl text-lg leading-9 text-gray-300">
            使うことで地球にも、人々の健康にも、そして地域の経済にも優しいMother Vegetableを、世界へと広げる仲間を募集します。
          </p>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-5xl">
          ...
          <div className="mt-8 grid gap-6 md:grid-cols-2">
            <article className="rounded-3xl border border-[#25C760]/30 bg-black/60 p-7">
              ...
              <h3 className="mt-3 text-2xl font-bold">Mazavege Shopの商品を販売可能</h3>
      ...
      <section className="px-6 py-16">
        <div className="mx-auto grid max-w-5xl gap-8 md:grid-cols-2">
          <div className="rounded-3xl border border-white/10 bg-white/[0.04] p-8">
            ...
            <p className="mt-5 text-3xl font-black">月額 100ドル</p>
            <p className="mt-2 text-gray-300">または 月額15,000円＋税</p>
          </div>
          <div className="rounded-3xl border border-white/10 bg-white/[0.04] p-8">
            <h2 className="text-2xl font-black text-[#25C760]">こんな方におすすめです</h2>
