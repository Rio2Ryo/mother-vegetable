        ...
        {isJa ? (
          <>
            ...
            <div className="py-3">
              ...
              <p className="mb-2"><strong>マザーベジタブル</strong>（「当社」、「私たち」）は <strong>https://mothervegetable.co.jp</strong>（以下「サービス」）を運営しています。</p>
            ...
            <div className="py-3">
              ...
              <p className="mb-2"><strong>サービス</strong>とは、マザーベジタブルが運営するhttps://mothervegetable.co.jpウェブサイトを意味します。</p>
          ...
          <>
            ...
            <div className="py-3">
              ...
              <p className="mb-2"><strong>Mother Vegetable&nbsp;</strong>(&ldquo;us&rdquo;, &ldquo;we&rdquo;, or &ldquo;our&rdquo;) operates <strong>https://mothervegetable.co.jp</strong> (hereinafter referred to as <strong>&ldquo;Service&rdquo;</strong>).</p>
              <p className="mb-2">Our Privacy Policy governs your visit to <strong>https://mothervegetable.co.jp</strong>, and explains how we collect, safeguard and disclose information that results from your use of our Service.</p>
            ...
            <div className="py-3">
              ...
              <p className="mb-2"><strong>SERVICE</strong> means the https://mothervegetable.co.jp website operated by Mother Vegetable.</p>
