...
const skinConditions: ApplicationSection[] = [
  ...
  },
  {
    ...
    title: 'Odor',
    image: '10004.jpg',
    method: 'SURIKOMU or MAZEKOMU',
    amount: 'SURIKOMU: as needed / MAZEKOMU: Body Lotion + 1/10 stick',
  },
  {
    number: 4,
    ...
    image: '10005.jpg',
    method: 'SURIKOMU or MAZEKOMU',
    amount: 'SURIKOMU: as needed / MAZEKOMU: Ointment + 1/10 stick',
  },
  {
    number: 5,
    title: 'Burn Scars',
    image: '10006.jpg',
    method: 'MAZEKOMU into ointment',
  ...
  },
  {
    ...
    title: 'Hair Thinning',
    image: '10007.jpg',
    method: 'MAZEKOMU into shampoo / hair tonic',
...
const skincareProducts: ApplicationSection[] = [
  ...
  },
  {
    ...
    title: 'Face Wash',
    image: '10011.jpg',
    method: 'MAZEKOMU into face wash',
  ...
  },
  {
    ...
    title: 'Face Cream',
    image: '10016.jpg',
    method: 'MAZEKOMU into face cream',
  ...
  },
  {
    ...
    title: 'Face Mask',
    image: '10017.jpg',
    method: 'SURIKOMU before face mask',
  ...
  },
  {
    ...
    image: '10018.jpg',
    method: 'MAZEKOMU into sunscreen',
  ...
  },
  {
    ...
    image: '10020.jpg',
    method: 'MAZEKOMU into foundation',
  ...
  },
  {
    ...
    title: 'Face Powder',
    image: '10021.jpg',
    method: 'MAZEKOMU into face powder',
...
const hairCare: ApplicationSection[] = [
  ...
  },
  {
    ...
    image: '10023.jpg',
    method: 'MAZEKOMU into treatment',
  ...
  },
  {
    ...
    title: 'Hair Pack',
    image: '10024.jpg',
    method: 'MAZEKOMU into hair pack',
...
const bodyCare: ApplicationSection[] = [
  {
    ...
    title: 'Body Soap',
    image: '10026.jpg',
    method: 'MAZEKOMU into body soap',
  ...
  },
  {
    ...
    title: 'Hand Soap',
    image: '10027.jpg',
    method: 'MAZEKOMU into hand soap',
  ...
  },
  {
    ...
    title: 'Body Cream',
    image: '10028.jpg',
    method: 'MAZEKOMU into body cream',
    amount: 'Direct: + 1/10 stick / Bottle: 100ml + 1 stick',
  },
  {
    number: 28,
    title: 'Shaving Foam',
    image: '10029.jpg',
    method: 'MAZEKOMU into shaving foam',
...
const otherPersonalCare: ApplicationSection[] = [
  {
    ...
    title: 'Hand Cream',
    image: '10031.jpg',
    method: 'MAZEKOMU into hand cream',
    amount: 'Direct: + 1/10 stick / Bottle: 100ml + 1 stick',
  },
  {
    number: 31,
    title: 'Tooth Paste',
    image: '10032.jpg',
    method: 'MAZEKOMU into toothpaste',
  ...
  },
  {
    ...
    title: 'Mouthwash',
    image: '10033.jpg',
    method: 'MAZEKOMU into mouthwash',
    amount: 'Direct: + 1/10 stick / Bottle: 100ml + 1 stick',
    notes: ['FDA Premium Food Grade safe'],
  },
  {
  ...
  },
  {
    ...
    title: 'Antiseptic',
    image: '10035.jpg',
    method: 'MAZEKOMU into antiseptic',
    amount: 'Direct: + 1/10 stick / Bottle: 100ml + 1 stick',
  },
  {
    number: 35,
  ...
  },
  {
    ...
    title: 'Lip Balm',
    image: '10037.jpg',
    method: 'MAZEKOMU into lip balm',
    amount: 'Lip balm + 1/10 stick',
    notes: ['Apply to balm or SURIKOMU directly first'],
  },
];
