    ...
    <AnimatePresence>
      {isOpen && (
        <>
          ...
          {/* Panel */}
          <motion.div
            className="fixed top-0 right-0 w-full md:w-[40%] h-screen bg-black border-l border-[#25C760] shadow-[-5px_0_30px_rgba(0,0,0,0.5)] z-[11]"
            initial={{ x: '100%' }}
            animate={{ x: 0 }}
            exit={{ x: '100%' }}
              ...
              {items.length === 0 ? (
                ...
                items.map((item, index) => (
                  <motion.div
                    ...
                    className="flex gap-4 p-3 mb-3 border border-[rgba(37,199,96,0.15)] rounded-lg shadow-[0_2px_7px_rgba(0,0,0,0.2)] hover:border-[#25C760] transition-all duration-200"
                  >
                    ...
                    <div className="flex flex-col justify-center flex-1">
                      ...
                      <div className="flex items-center gap-2 mt-2">
                        ...
                        <div className="flex items-center border border-[#25C760] rounded-[5px]">
                          <button
                            className="px-2 text-[#25C760] bg-transparent border-none cursor-pointer text-lg hover:bg-[#25C760] hover:text-black transition-colors duration-200 rounded-l-[4px]"
                          ...
                          <button
                            className="px-2 text-[#25C760] bg-transparent border-none cursor-pointer text-lg hover:bg-[#25C760] hover:text-black transition-colors duration-200 rounded-r-[4px]"
                            onClick={() => updateQuantity(item.id, item.quantity + 1)}
                          >
                            +
                          </button>
                        ...
                        <button
                          className="ml-2 bg-transparent border-none cursor-pointer text-[#25C760] hover:text-red-500 transition-colors duration-200"
