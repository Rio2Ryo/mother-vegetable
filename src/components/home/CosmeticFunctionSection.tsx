    ...
    <>
      ...
      >
        ...
        <div className="max-w-3xl mx-auto px-0 md:px-4">
          ...
          <div className="flex flex-wrap justify-center gap-2 md:grid md:grid-cols-5 md:gap-3 mb-8">
            {cosmeticNutrients.map((nutrient, index) => (
              <div key={index} className="border-2 border-green-300 rounded-lg px-2 py-2 md:px-3 md:py-3 bg-green-800/50 hover:bg-green-700/50 transition-colors text-center flex flex-col items-center justify-center w-[28%] md:w-auto">
                <div className="text-white text-[9px] md:text-xs font-semibold leading-tight">
        ...
        <div className="max-w-4xl mx-auto px-4 md:px-4 mt-12 md:mt-16">
          ...
          <div className="flex flex-col items-center gap-4 mb-8">
            <button
              onClick={handleCopy}
              className="group flex items-center gap-2 md:gap-3 px-4 py-3 md:px-10 md:py-5 rounded-2xl font-bold text-[3.2vw] md:text-lg transition-all duration-300 hover:scale-105 border-2 border-[#25c760] bg-transparent hover:bg-[#25c760]/10 whitespace-nowrap"
              style={{ color: '#25c760' }}
            >
              ...
              <span>{isJa ? '上記成分をクリップボードにコピー' : cosmeticTexts.copyButton}</span>
            </button>
            {copied && (
