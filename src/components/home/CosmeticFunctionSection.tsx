...
export default function CosmeticFunctionSection() {
  ...
  const featuresTable = isJa
    ? [
        ['植物の始祖に当たるMother Vegetableのみを使用した完全天然素材/天然栄養素', '塗るタイプのMother Vegetableは、主成分が非晶質の無水ケイ酸'],
        ['PM2.5や虫・鳥などの混入が起こらない完全室内培養', '重金属・マイクロプラスチック汚染リスクを極限まで排除'],
...
・PM2.5や虫・鳥などの混入が起こらない完全室内培養（Closed Bioreactor System）
