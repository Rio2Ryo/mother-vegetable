...
export default function PartnerSwitch({ active, locale = 'ja' }: { active: PartnerKind; locale?: string }) {
  ...
  const items = [
    {
      ...
      subtitle: isEn ? 'Sell products' : '商品を販売する人',
    ...
    },
    {
      ...
      subtitle: isEn ? 'Create products' : '商品を作る人',
